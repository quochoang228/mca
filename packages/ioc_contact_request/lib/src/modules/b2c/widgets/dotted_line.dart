...
class DottedLine extends StatelessWidget {
  ...
  Color _calculateGradientColor(
    ...
    return startColor.withAlpha(startColor.alphaValue + amountOfChangeInAlphaPerItem * index).withRed(startColor.redValue + amountOfChangeInRedPerItem * index).withGreen(startColor.greenValue + amountOfChangeInGreenPerItem * index).withBlue(startColor.blueValue + amountOfChangeInBluePerItem * index);
  }
}
